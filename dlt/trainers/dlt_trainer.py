...
class TrainLoopDLT:
    ...
    def train_epoch(self, epoch):
        ...
        for step, batch in enumerate(self.train_dataloader):
            ...
            # print("###################################################################")
            # print("batch[box].shape: ", batch['box'].shape)
            # print("batch[cat].shape: ", batch['cat'].shape)
            # print("batch[box_cond].shape: ", batch['box_cond'].shape)
            # print("batch[mask_box].shape: ", batch['mask_box'].shape)
            # print("batch[mask_cat].shape: ", batch['mask_cat'].shape)
            # print("###################################################################")
        ...
        #safetensors.save_model(model_clone, save_path / "model.pth")
        safetensors.save_model(self.model, save_path / "model.pth")
       # model_clone.save_pretrained(save_path)
